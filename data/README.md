...
carries at least a pH column (`pH` and `Adjusted pH`) and a chemical-shift column
(`Chemical Shift (ppm)`, or `deltai_calc` in the other-CF2 files). Columns are located by
